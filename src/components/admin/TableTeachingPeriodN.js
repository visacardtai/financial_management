...
const TableTeachingPeriodN = () => {
  ...
  const handleEdit = () => {
    if (itemSelect) {
      dispatch(actions.getDataEditTeachingPeriod(itemSelect));
      dispatch(actions.checkBlur(true));
      dispatch(actions.changeTypeBlur(42));
    }
  };
                  ...
                  {visibleRows?.map((row, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="left">
                          {helpFn.converVND(row?.lecturePrice?.basic_price)}
                        </TableCell>
                        <TableCell align="left">
                          {row?.lecturePrice?.coefficient}
                        </TableCell>
                        <TableCell align="left">
                          {row?.targets?.quantity}
                        </TableCell>
...
export default TableTeachingPeriodN;
