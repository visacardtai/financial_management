...
import TableCreditPriceNon from "../../components/admin/TableCreditPriceNon";
import TableCreditPrice from "../../components/admin/TableCreditPrice";
...
const CreditPrice = () => {
  ...
  return (
    ...
    //       <TableCreditPriceNon actions={handleClickDelete} data={addSelected} />
    //     </div>
    //   </div>
    //   {clickAdd && <Blur actions={handleClick} type={0} />}
    //   {clickDelete && (
    //     <Blur actions={handleClickDelete} type={1} data={selected} />
    //   )}
    // </div>
    <div className="flex w-full h-full">
