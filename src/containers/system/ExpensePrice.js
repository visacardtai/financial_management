...
import { TableExpPrice, TableExpPriceNon } from "../../components/admin/";
...
const ExpensePrice = () => {
  ...
  return (
    ...
    //       <TableExpPriceNon actions={handleClickDelete} data={addSelected} />
    //     </div>
    //   </div>
    //   {clickAdd && <Blur actions={handleClick} type={3} />}
    //   {clickDelete && (
    //     <Blur actions={handleClickDelete} type={1} data={selected} option={2} />
    //   )}
    // </div>
    <div className="flex w-full h-full">
